...
=== Annexe 2 Retranscription interview M. Babtsite ....
...
Il y a beaucoup d'entreprises qui font du green wasching, c’est très à la mode ( de dire j'ai fait concevoir un éco-logiciel sans savoir ce qu'ils font).
...
*Le green IT est un sujet très intéressant mais compliqué à appliquer. Est-ce-qu le logiciel fait viellir le matériel ?*

Le logiciel a un impact sur le matériel. Un site mal conçu demande plus de ressources en énergie. c’est le logiciel qui a un impact.
