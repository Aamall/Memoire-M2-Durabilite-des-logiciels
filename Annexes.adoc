...
La solution pour éviter ça, c'est d'éco-concevoir le logiciel. On fait en sorte d'utiliser plus longtemps le matériel (qui soient dans data-center, qui soient aussi avec les utilisatuers). C'est dans ce cycle là que se positionne l'éco-conception logiciel.
