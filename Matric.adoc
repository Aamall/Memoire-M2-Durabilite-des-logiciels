...
[#Matrice]
== 6.Les clés de la durabilité de logiciels (Matrice)
...
Ce critère a été défini par l'interview <<Annexe 4>>. 
...
Ce critère a été difinie par l'interview <<Annexe 4>>.
