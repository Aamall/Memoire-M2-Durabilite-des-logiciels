...
* Quanzième critère a obtenu la valeur 80 - 100% : Éco2mix est un logiciel mobile et web. Donc il ne utilise pas le RAM et le Disque Dur.

* Seizième critère a obtenu la valeur 20 - 40% : Éco2mix a la note 20 - 40% pour l'optimiser l'utilisation du Mémoire. 
