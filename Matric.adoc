...
* Dix-huitième critère a obtenu la valeur 0 - 20% : Éco2mix a obtenu cette valeur parce qu'il est développé en closed-source.

* Dix-neuvième critère a obtenu la valeur 20 - 40% : Éco2mix subit souvent des Bugs.

* Vigntième critère a obtenu la valeur 40 - 60% : le code d'Éco2mix est un peu compliqué en quelques sortes.
