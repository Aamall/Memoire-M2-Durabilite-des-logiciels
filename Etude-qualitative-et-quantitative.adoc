...
| Combien d’années d’expérience en matière de programmation avez-vous ? | 1 – 3 ans/ 3 – 5 ans/ 5 – 10 ans/Plus de 10 ans |Un seul choix
...
| Développez-vous des logiciels /applications pour Smartphones ? | Oui/ Non |Un seul choix
...
| How many years of programming experience de you have ? | 1 – 3 years/ 3 – 5 years/ 5 – 10 years/ More than 10 years |Un seul choix
...
|Do you develop software/application for Smartphones ? | Yes/ No | Un seul choix
...
| Tenez-vous compte de la consommation d'énergie lors du développement de logiciels ? Si oui, comment comptabilisez-vous la consommation d'énergie ? a|* Non malheureusement
* Pas vraiment
...
* No Just avoiding unuseful elaborations| Texte libre
