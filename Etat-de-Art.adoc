...
* Green fabrication : qui indique de fabriquer, dans un but d'avoir un impact minimal ou nul sur l'environnement, tous les composants électroniques, les ordinateurs, et les autres sous-systèmes associés.
