...
==== 3.2.4. Le logiciel peut aussi endommager le matériel  /// reste à faire ///

Il faut avoir une bonne conception avant de commencer à développer des logiciels ! 

Parfois, si la conception est mauvaise, cela nous conduit à un mauvais développement. Ce dernier va endommager le matériel plus rapidement qu'il n'est prévu. 
...
==== 3.2.5. Cycle de vie d'un matériel informatique 
...
==== 3.2.6. Cycle de vie d'un logiciel
