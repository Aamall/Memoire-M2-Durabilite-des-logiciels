...
[#Illustrations]
== 5.Illustrations pratiques ///reste à faire///
...
D'autre part, soit le code Python 3 suivant. Il est également récursif, mais en mode non cache. Dans ce cas, le code refait les calculs déjà effectués. Ce code n'est pas optimisé. Cela conduit à manquer l'optimisation énergétique.
